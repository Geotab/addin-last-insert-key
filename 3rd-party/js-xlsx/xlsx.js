...
function write_cellXfs(cellXfs) {
	...
	cellXfs.forEach(function(c) { o[o.length] = (writextag('xf', c.alignment ? (writextag('alignment', null, c.alignment)) : null, c)); });
	o[o.length] = ("</cellXfs>");
...
function write_cellFills(cellFills) {
	var o = [];
	cellFills.forEach(function(c) { o[o.length] = ('<fill><patternFill patternType="solid"><fgColor rgb="FF' + c.fgColor + '" /></patternFill></fill>'); });
	if(o.length === 2) return "";
	return o.join("");
}
...
function write_sty_xml(wb, opts) {
	...
	o[o.length] = ('<fonts count="1"><font><sz val="12"/><color theme="1"/><name val="Calibri"/><family val="2"/><scheme val="minor"/></font>');
	o[o.length] = ('<font><sz val="11" /><color theme="1" /><name val="Segoe UI" /><family val="2" /></font>');
	o[o.length] = ('<font><sz val="11" /><color theme="0" tint="-0.34998626667073579" /><name val="Segoe UI" /><family val="2" /></font>');
	o[o.length] = ('</fonts>');
	o[o.length] = ('<fills count="2"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill>');
	if(w = write_cellFills(opts.fills)) o[o.length] = (w);
	o[o.length] = ('</fills>');
...
function get_cell_style(styles, cell, opts) {
	if (!window.isNaN(cell.s) && cell.s !== null && styles[cell.s]) {
		return cell.s;
	}
...
function write_ws_xml_cell(cell, ref, ws, opts, idx, wb) {
	...
	var f = cell.f ? writetag('f', escapexml(cell.f)) : "";
	/* TODO: cell style */
...
function write_ws_xml(idx, opts, wb) {
	...
	if(ws['!frozen'] !== undefined) {
		o[o.length] = ('<sheetViews><sheetView tabSelected="1" workbookViewId="0"><pane ySplit="' + ws['!frozen'] + '" topLeftCell="' + encode_cell({ c: 0, r: ws['!frozen'] }) + '" activePane="bottomLeft" state="frozen" /></sheetView></sheetViews>');
